...
#еда будет появляться в допустимом месте на доске, а не в стенах или за пределами видимой области. 

foodBx = random.randrange(1,17) * 32
foodBy = random.randrange(3, 15) * 32
#устанавливает новый таймер для вызова самого себя после случайной задержки, 
#тем самым реализуя периодическое событие, изменяющее состояние 
